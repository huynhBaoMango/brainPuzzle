...
public class AdmobOpenAdsManager : MonoBehaviour
{
    ...
    public void setIsShowingAppOpen(bool isShowing)
    {
        IsShowingAppOpen = isShowing;
    }
    ...
    public bool isAppOpenAvailable
    {
        get
        {
            return appOpen != null && IsAppOpenLoaded == true && DateTime.Now < expireTime && !IsShowingAppOpen;
        }
    }
